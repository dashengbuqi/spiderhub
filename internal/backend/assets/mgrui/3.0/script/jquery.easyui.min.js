...
var _278="<div class=\"alertMsg\">"+msg+"</div>";
switch(icon){
case "error":
...
var _27b="<div class=\"messager-icon messager-question\"></div>"+"<div class=\"alertMsg\">"+msg+"</div>"+"<div style=\"clear:both;\"/>";
var _27c={};
...
$.fn.tabs.defaults={width:"auto",height:"auto",headerWidth:150,tabWidth:"auto",tabHeight:40,selected:0,showHeader:true,plain:false,fit:false,border:true,tools:null,toolPosition:"right",tabPosition:"top",scrollIncrement:100,scrollDuration:400,onLoad:function(_345){
...
/*new*/
if(col.editor){
cc.push("<span class='editorIconTarget'>编辑</span>");
}
/*new*/
cc.push("</div>");
cc.push("</td>");
...
$.fn.datagrid.defaults=$.extend({},$.fn.panel.defaults,{frozenColumns:undefined,columns:undefined,fitColumns:false,resizeHandle:"right",autoRowHeight:true,toolbar:null,striped:false,method:"post",nowrap:true,idField:null,url:null,data:null,loadMsg:"Processing, please wait ...",rownumbers:false,singleSelect:false,selectOnCheck:true,checkOnSelect:true,pagination:false,pagePosition:"bottom",pageNumber:1,pageSize:15,pageList:[15,30,45,150,500,1000],queryParams:{},sortName:null,sortOrder:"asc",multiSort:false,remoteSort:true,showHeader:true,showFooter:false,scrollbarSize:18,rowStyler:function(_6c3,_6c4){
        ...
        return jq.each(function () {
            ...
            if (!options.tooltip) {
                ...
                panel.find('.datagrid-body').each(function () {
                    ...
                    $(delegateEle).find('td').hover(function(e) {
