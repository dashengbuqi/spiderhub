    ...
    var operateBtn = function _opeateBtn() {
        ...
        this.run = function () {
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: '/crawler/api/debug-start?app_id='+app_id,
        ...
        this.stop = function (){
            ...
            $.ajax({
                type: 'post',
                dataType: 'json',
                url: '/crawler/api/debug-end?app_id='+app_id+'&test_id='+test_id,
                data: target._getParams(),
                success: function (data) {
                    if(data.status==1){
                      //  clearInterval(_INTERVAL);
        ...
        this.getLogs = function () {
            _INTERVAL = setInterval(function () {
                $.ajax({
                    type: 'post',
                    dataType: 'json',
                    url: '/crawler/api/debug-heart-beat?app_id='+app_id+'&test_id='+test_id,
                    data: target._getParams(),
                    success: function (data) {
                        var str ='';
                        if(data.status==1){
